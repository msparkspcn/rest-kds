...
const Login: React.FC = () => {
    ...
    return (
        <div className="flex h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <h1 className="mt-10 text-center text-5xl/9 font-bold tracking-tight text-gray-900">{STRINGS.project_name}</h1>
            <h2 className="mt-3 text-center text-2xl/9 font-bold tracking-tight text-gray-900">{STRINGS.member_login}</h2>
